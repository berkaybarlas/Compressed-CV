...
\cvopenentry
    ...
    {Stanford University Design School} % Organization/group
    {Stanford University} % Location
    {Oct. 2019 - 2021} % Date(s)
    {
    \begin{cvitems} % Description(s) of experience/contributions/knowledge
        \item {Concluded a 7-week-long design thinking and innovation course at Hasso Plattner Institute of Design (d.school).}
        \item {Was section leader of a Java teaching program for 2 summers directed by Nick McKeown at Stanford.}
     \end{cvitems}
    }
\begin{comment}
%---------------------------------------------------------
